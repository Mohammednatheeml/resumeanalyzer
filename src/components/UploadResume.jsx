  ...
  const handleDrop = (e) => {
    ...
    if (droppedFile) {
      ...
      if (["pdf", "doc", "docx", "txt"].includes(fileExtension)) {
        ...
        setError(
          "Unsupported file format. Please upload PDF, DOC, DOCX, or TXT files only."
        );
      }
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://resumebackend-1-degz.onrender.com/api/analyze",
        {
          method: "POST",
          body: formData,
        }
    ...
    <div className={`upload-container ${isReady ? "ready" : ""}`}>
      ...
      <div className="resume-content-wrapper">
        ...
        <p className="upload-subtitle">
          Upload your resume for <span>AI-powered career insights</span> and
